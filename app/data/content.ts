...
type LocalizedContent = {
  ...
  graphicDesign: {
    ...
    archiveLabel: string;
    archiveValue: string;
    items: { title: string; type: string; year: string; note: string; image?: string; orientation?: "portrait" | "landscape" }[];
  };
  stack: {
    kicker: string;
    title: string;
...
export const contentByLocale: Record<Locale, LocalizedContent> = {
  es: {
    ...
    graphicDesign: {
      ...
      title: "carteles, piezas y memoria visual de Matet.",
      body: "Aquí van reunidas las piezas gráficas que he ido haciendo alrededor de las fiestas de Matet: carteles, portadas, variaciones y composiciones pensadas para comunicar sin perder tono de pueblo.",
      archiveLabel: "Archivo festivo",
      archiveValue: "Matet · 14 piezas · carteles · programas · composiciones",
      items: [
        {
          title: "Resumen de fiestas",
          type: "portada editorial",
          year: "2026",
          note: "La pieza principal del conjunto: una portada-resumen para abrir programa con presencia, jerarquía clara y una dirección visual más sobria.",
          image: "/projects/matet-graphics/cartel_resumenfiestas.png",
          orientation: "portrait",
        },
        {
          title: "Resumen taurino",
          type: "cartel vertical",
          year: "serie",
          note: "Pieza específica para reunir la parte taurina dentro del mismo universo visual festivo.",
          image: "/projects/matet-graphics/cartel_resumentoros.png",
          orientation: "portrait",
        },
        {
          title: "Hora feliz",
          type: "formato panorámico",
          year: "serie",
          note: "Versión más horizontal, pensada para composiciones amplias y piezas de mayor impacto visual.",
          image: "/projects/matet-graphics/cartel_horafelizdelante.png",
          orientation: "landscape",
        },
        {
          title: "Trasera hora feliz",
          type: "formato panorámico",
          year: "serie",
          note: "Pieza de apoyo para la promoción de hora feliz, manteniendo el mismo lenguaje gráfico en formato apaisado.",
          image: "/projects/matet-graphics/cartel_horafelizdetras.png",
          orientation: "landscape",
        },
        {
          title: "Eclipse solar",
          type: "cartel vertical",
          year: "serie",
          note: "Cartel temático para uno de los eventos del programa, con una estética más marcada y protagonista.",
          image: "/projects/matet-graphics/cartel_eclipsesolar.png",
          orientation: "portrait",
        },
        {
          title: "Gafas para eclipse solar",
          type: "formato panorámico",
          year: "serie",
          note: "Pieza horizontal pensada para comunicar una acción concreta sin romper el sistema visual del conjunto.",
          image: "/projects/matet-graphics/cartel_gasfaseclipsesolar.png",
          orientation: "landscape",
        },
        {
          ...
          type: "cartel vertical",
          year: "serie",
          note: "Cartel específico para la fiesta ibicenca, manteniendo la coherencia con el resto del archivo.",
          image: "/projects/matet-graphics/cartel_fiestaibicenca.png",
          orientation: "portrait",
        },
        {
          title: "Fiesta ochentera",
          type: "cartel vertical",
          year: "serie",
          note: "Otra derivación del lenguaje gráfico para una fiesta temática más reconocible y expresiva.",
          image: "/projects/matet-graphics/cartel_fiestaochentera.png",
          orientation: "portrait",
        },
        {
          title: "Fiestas para niños",
          type: "cartel vertical",
          year: "serie",
          note: "Pieza pensada para comunicar la parte infantil del programa con un tono más amable y directo.",
          image: "/projects/matet-graphics/cartel_fiestasnins.png",
          orientation: "portrait",
        },
        {
          title: "Bebidas",
          type: "cartel vertical",
          year: "serie",
          note: "Cartel de apoyo para hostelería y consumiciones, pensado para lectura rápida y directa.",
          image: "/projects/matet-graphics/cartel_bebidas.png",
          orientation: "portrait",
        },
        {
          title: "Comidas",
          type: "cartel vertical",
          year: "serie",
          note: "Pieza de la misma familia visual para informar sobre la oferta de comidas.",
          image: "/projects/matet-graphics/cartel_comidas.png",
          orientation: "portrait",
        },
        {
          title: "Cubatas",
          type: "cartel vertical",
          year: "serie",
          note: "Otra pieza del sistema, orientada a bebidas y pensada para funcionar en barra o punto de venta.",
          image: "/projects/matet-graphics/cartel_cubatas.png",
          orientation: "portrait",
        },
        {
          title: "Chupitos",
          type: "cartel vertical",
          year: "serie",
          note: "Formato individual preparado para destacar una promoción concreta dentro del ambiente festivo.",
          image: "/projects/matet-graphics/cartel_chupitos.png",
          orientation: "portrait",
        },
        {
          title: "Chupinazo",
          type: "cartel vertical",
          year: "serie",
          note: "Composición pensada para anunciar uno de los momentos más reconocibles del arranque de fiestas.",
          image: "/projects/matet-graphics/cartel_chupinazo.png",
          orientation: "portrait",
        },
      ],
    },
  ...
  va: {
    ...
    graphicDesign: {
      ...
      title: "cartells, peces i memòria visual de Matet.",
      body: "Ací van reunides les peces gràfiques que he anat fent al voltant de les festes de Matet: cartells, portades, variacions i composicions pensades per a comunicar sense perdre to de poble.",
      archiveLabel: "Arxiu festiu",
      archiveValue: "Matet · 14 peces · cartells · programes · composicions",
      items: [
        {
          title: "Resum de festes",
          type: "portada editorial",
          year: "2026",
          note: "La peça principal del conjunt: una portada-resum per a obrir programa amb presència, jerarquia clara i una direcció visual més sòbria.",
          image: "/projects/matet-graphics/cartel_resumenfiestas.png",
          orientation: "portrait",
        },
        {
          title: "Resum taurí",
          type: "cartell vertical",
          year: "sèrie",
          note: "Peça específica per a reunir la part taurina dins del mateix univers visual festiu.",
          image: "/projects/matet-graphics/cartel_resumentoros.png",
          orientation: "portrait",
        },
        {
          title: "Hora feliç",
          type: "format panoràmic",
          year: "sèrie",
          note: "Versió més horitzontal, pensada per a composicions àmplies i peces de major impacte visual.",
          image: "/projects/matet-graphics/cartel_horafelizdelante.png",
          orientation: "landscape",
        },
        {
          title: "Darrere hora feliç",
          type: "format panoràmic",
          year: "sèrie",
          note: "Peça de suport per a la promoció d'hora feliç, mantenint el mateix llenguatge gràfic en format apaïsat.",
          image: "/projects/matet-graphics/cartel_horafelizdetras.png",
          orientation: "landscape",
        },
        {
          ...
          type: "cartell vertical",
          year: "sèrie",
          note: "Cartell temàtic per a un dels esdeveniments del programa, amb una estètica més marcada i protagonista.",
          image: "/projects/matet-graphics/cartel_eclipsesolar.png",
          orientation: "portrait",
        },
        {
          title: "Ulleres per a l'eclipsi solar",
          type: "format panoràmic",
          year: "sèrie",
          note: "Peça horitzontal pensada per a comunicar una acció concreta sense trencar el sistema visual del conjunt.",
          image: "/projects/matet-graphics/cartel_gasfaseclipsesolar.png",
          orientation: "landscape",
        },
        {
          title: "Festa eivissenca",
          type: "cartell vertical",
          year: "sèrie",
          note: "Cartell específic per a la festa eivissenca, mantenint la coherència amb la resta de l'arxiu.",
          image: "/projects/matet-graphics/cartel_fiestaibicenca.png",
          orientation: "portrait",
        },
        {
          title: "Festa vuitantera",
          type: "cartell vertical",
          year: "sèrie",
          note: "Una altra derivació del llenguatge gràfic per a una festa temàtica més reconeixible i expressiva.",
          image: "/projects/matet-graphics/cartel_fiestaochentera.png",
          orientation: "portrait",
        },
        {
          title: "Festes per a xiquets",
          type: "cartell vertical",
          year: "sèrie",
          note: "Peça pensada per a comunicar la part infantil del programa amb un to més amable i directe.",
          image: "/projects/matet-graphics/cartel_fiestasnins.png",
          orientation: "portrait",
        },
        {
          ...
          type: "cartell vertical",
          year: "sèrie",
          note: "Cartell de suport per a hostaleria i consumicions, pensat per a lectura ràpida i directa.",
          image: "/projects/matet-graphics/cartel_bebidas.png",
          orientation: "portrait",
        },
        {
          ...
          type: "cartell vertical",
          year: "sèrie",
          note: "Peça de la mateixa família visual per a informar sobre l'oferta de menjars.",
          image: "/projects/matet-graphics/cartel_comidas.png",
          orientation: "portrait",
        },
        {
          ...
          type: "cartell vertical",
          year: "sèrie",
          note: "Una altra peça del sistema, orientada a begudes i pensada per a funcionar en barra o punt de venda.",
          image: "/projects/matet-graphics/cartel_cubatas.png",
          orientation: "portrait",
        },
        {
          ...
          type: "cartell vertical",
          year: "sèrie",
          note: "Format individual preparat per a destacar una promoció concreta dins de l'ambient festiu.",
          image: "/projects/matet-graphics/cartel_chupitos.png",
          orientation: "portrait",
        },
        {
          ...
          type: "cartell vertical",
          year: "sèrie",
          note: "Composició pensada per a anunciar un dels moments més reconeixibles de l'inici de festes.",
          image: "/projects/matet-graphics/cartel_chupinazo.png",
          orientation: "portrait",
        },
      ],
